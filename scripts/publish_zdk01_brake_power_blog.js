...
const productUrl = '/product.html?slug=zdk-01-elevator-brake-power-controller';
...
async function main() {
  ...
  console.log(JSON.stringify({
    ...
    id: result.id,
    slug: payload.slug,
    url: `https://rogersense.com/blog-post.html?slug=${encodeURIComponent(payload.slug)}`,
    coverUrl,
  }, null, 2));
}
